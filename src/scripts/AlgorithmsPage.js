const algorithms = {
    deutsch: {
        ...
        desc: "ตรวจว่าฟังก์ชันเป็นแบบ constant หรือ balanced",
        steps: [
            {
                title: "กำหนดสถานะเริ่มต้น",
                desc: "เตรียมคิวบิตสองตัวใน computational basis",
                circuit: ["|0>", "|1>"],
            ...
            {
                title: "ใช้ Hadamard",
                desc: "สร้างซูเปอร์โพซิชันให้คิวบิตทั้งสอง",
                circuit: ["H", "H"],
            ...
            {
                title: "ส่งผ่าน Oracle",
                desc: "ทดสอบฟังก์ชันที่ไม่รู้ล่วงหน้าในซูเปอร์โพซิชัน",
                circuit: ["H", "U_f", "H"],
            ...
            {
                title: "วัดผลลัพธ์",
                desc: "วัดคิวบิตตัวแรกเพื่อบอกคุณสมบัติของฟังก์ชัน",
                circuit: ["H", "U_f", "H", "วัด"],
    ...
    grover: {
        name: "Grover Search",
        desc: "ค้นหาเป้าหมายในฐานข้อมูลที่ไม่เรียงลำดับด้วยความเร็วเพิ่มขึ้นระดับกำลังสอง",
        steps: [
            {
                title: "สร้างซูเปอร์โพซิชันเริ่มต้น",
                desc: "กระจายความน่าจะเป็นให้ครอบคลุมทุกคำตอบ",
                circuit: ["H", "H", "H"],
            ...
            {
                title: "ใช้ Oracle",
                desc: "ทำเครื่องหมายคำตอบเป้าหมายด้วย phase flip",
                circuit: ["H", "Oracle", "H"],
            ...
            {
                title: "ใช้ Diffusion",
                desc: "ขยายแอมพลิจูดของคำตอบเป้าหมาย",
            ...
            {
                title: "วัดผลลัพธ์",
                desc: "วัดคิวบิตเพื่ออ่านคำตอบที่มีโอกาสสูงสุด",
    ...
    teleport: {
        ...
        desc: "ส่งผ่านสถานะควอนตัมด้วยเอนแทงเกิลเมนต์และบิตคลาสสิก",
        steps: [
            {
                title: "สร้าง Bell Pair",
                desc: "สร้างคู่เอนแทงเกิลระหว่าง Alice และ Bob",
                circuit: ["|psi>", "H", "CNOT"],
            ...
            {
                title: "วัดคิวบิตฝั่ง Alice",
                desc: "ทำ Bell measurement กับอินพุตและครึ่งหนึ่งของคู่เอนแทงเกิล",
            ...
            {
                title: "ส่งบิตคลาสสิก",
                desc: "ส่งผลลัพธ์การวัดสองบิตไปให้ Bob",
                circuit: ["บิต 1", "บิต 2", ">>>"],
            ...
            {
                title: "กู้คืนสถานะ",
                desc: "Bob ใช้เกต Pauli ที่เหมาะสมเพื่อสร้างสถานะเดิม",
